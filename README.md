...
- **Charts** - Utilizes a charting library (e.g., Chart.js) to display:
  ...
  2.**Pie/Donut Chart** - Expense Distribution by Category.

  3.**Line Chart** - Cumulative Balance Over Time.
...
│  
├── 📄 **index.html, dasboard.html** — Main UI structure  
├── 🎨 **styles.css** — Interactive CSS styling  
├── ⚙️ **util.js, transaction.js,dashboard.js** — Core logic (CRUD, filters, local storage, dark/light mode, reset)  
